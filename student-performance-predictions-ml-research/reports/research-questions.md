...
## Two-Scenario Design
This project uses two modeling scenarios: a full-information scenario and an early-
warning scenario. In the full-information scenario, models may use G1 and G2 to
